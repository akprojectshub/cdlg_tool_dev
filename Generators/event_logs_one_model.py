...
def generate_logs_with_model(tree_one):
    ...
    min_duration = input_int(
        "Minimum for the duration of the activities in the event log in seconds (int) {default: 1}: ")
    max_duration = input_int_max(
        "Maximum for the duration of the activities in the event log in seconds (int) {default: }: ",
        min_duration)
    print("\n--- INPUT DRIFT ---")
